...
;A simple MASM program comparing two string
;return 1 if two string are anagrams
;return 0 if two string are not anagrams
;get help from Yinhong Chen
...
.code
    main proc
        ...
        CounterLoop:                ;this will increment the proper 'elements' of c1 and c2
            ...
            sub edi, 65              ;(4) increment the second counter at the value - 65.
            inc c2[edi]
