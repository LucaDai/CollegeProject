...
public abstract class CloudStorage {
   ...
   */
   ...
   /**
    * @param obj1 - the object want to compare.
    * @return 1/-1/0 represent greater/less/equal.
    */
   public int compareTo(CloudStorage obj1) {
      return name.compareToIgnoreCase(obj1.getName()); 
   }
